...
public class Validator
{
    ...
    private static final Logger _LOGGER = LoggerFactory.getLogger(Validator.class);
    ...
    public Validator(Pack... packs) {
        ...
        _LOGGER.debug("Validator(): {} cards in valid list", validCards.size());
    ...
    private boolean isInvalidCard(Card card) {
        ...
        if (!validCards.remove(card)) {
            ...
            _LOGGER.warn("Invalid card found: {}", card);
            return true;
    ...
    public boolean validateCardStream(Stream<Card> stream) {
        ...
        _LOGGER.debug("validateCardStream(): {} invalid cards found", invalidCards);
    ...
    public boolean validateContainer(CardContainer container) {
        ...
        _LOGGER.debug("validateContainer(): {}: {} invalid cards found", container, invalidCards);
        return invalidCards == 0L;
    ...
    public boolean validatePile(Pile pile) {
        ...
        _LOGGER.debug("validatePile(): {}: {} invalid cards found", pile, invalidCards);
        return invalidCards == 0L;
