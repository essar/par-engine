...
public class Hand
{
    ...
    public Card findCard(Card card) {
        ...
        try {
            ...
            _LOGGER.debug("findCard(): Match found: {}", foundCard);
            return foundCard;

        } catch (NoSuchElementException e) {

            _LOGGER.debug("findCard(): No match");
            return null;
    ...
    public void removeCard(Card card) {
        ...
        synchronized (cards) {
            ...
            _LOGGER.debug("removeCard(): {}", card);

            Card resolvedCard = findCard(card);
            if (resolvedCard == null || !cards.contains(resolvedCard)) {

                throw new IllegalArgumentException("Card not contained in hand");

            }
            _LOGGER.debug("removeCard(): Removed {}", resolvedCard);
